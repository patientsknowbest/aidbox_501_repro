...
dependency "multibox" {
  ...
  mock_outputs = {
    multibox_container_metrics_port = "multibox_container_metrics_port"
...
inputs = {
  ...
  multibox_container_metrics_port = dependency.multibox.outputs.multibox_container_metrics_port
